...
---@return boolean
function engine.Con_IsVisible() return nil end

---@return boolean
function engine.IsGameUIVisible() return nil end

---@return boolean
function engine.IsTakingScreenshot() return nil end
...
---@param z number
---@return any
function engine.GetPointContents(x, y, z) return nil end

---@return string
function engine.GetMapName() return nil end

---@return string
function engine.GetServerIP() return nil end
